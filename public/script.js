...
document.addEventListener('click', function(e) {
    ...
    const menuDropdown = document.querySelector('.menu-hotel'); // The dropdown for luxury, premium, and economical
    const loginButton = document.querySelector('.unified-btn'); // Login/Signup button in mobile view
    
    // Close the mobile menu if clicking outside of the hamburger button or the menu
    if (menu && !menu.contains(e.target) && !hamburger.contains(e.target) && !menuDropdown.contains(e.target) && !loginButton.contains(e.target)) {
        menu.classList.remove('active');
    }
    
    // Close the menu dropdown if clicking outside of the dropdown
    if (menuDropdown && !menuDropdown.contains(e.target) && !hamburger.contains(e.target)) {
